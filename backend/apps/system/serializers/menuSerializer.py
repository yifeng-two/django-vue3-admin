...
from apps.system.models import Menu, MenuButton
...
class MenuInitSerializer(CustomModelSerializer):
    ...
    def save(self, **kwargs):
        ...
        if menu_button:
            for menu_button_data in menu_button:
                ...
                serializer = MenuButtonSerializer(instance_obj,
                                                  data=menu_button_data,
    ...
    class Meta:
        model = Menu
        fields = [
            'name', 'icon', 'sort', 'is_link', 'is_catalog', 'web_path', 'component',
            'component_name', 'status', 'cache', 'visible', 'parent', 'children', 'menu_button',
...
class WebRouterSerializer(CustomModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'parent', 'icon', 'sort', 'path', 'name', 'title', 'is_link', 'is_catalog',
                  'web_path', 'component', 'component_name', 'cache', 'visible', 'menuPermission')
        read_only_fields = ["id"]
